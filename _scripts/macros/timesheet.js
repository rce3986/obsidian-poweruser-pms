class Timesheet {
    timesheet(dv) {
        ...
        const NONE_TAG = "#none";
        const TEMPLATES_FOLDER = dv.app.plugins.plugins["templater-obsidian"].settings.templates_folder;
        const ZETTEL_DATE_FORMAT = "YYYY-MM-DD ddd HH;mm;ss";
        ...
        for (const [day, timeEntryArray] of dayToTimeEntryArray) {
            ...
            for (let i = 1; i < nTimeEntries; i++) {
                ...
                const program = timeEntryArray[i - 1].file.tags
